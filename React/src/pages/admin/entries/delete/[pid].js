...
export default function DeleteEntry(){
    ...
    return(
        <div className="container mx-auto max-w-3xl bg-white p-6 rounded shadow-lg border-solid border-2 border-gray-300">
            ...
            <h1 className="text-3xl font-bold mb-8">Exclusão do lançamento:</h1>
            ...
            <form>
                ...
                <div className="mb-4">
                    <label htmlFor="account" className="block text-sm font-medium text-gray-700">Conta relacionada:</label>
                    <input
                        id="account"
                        type="text"
                        value={entry.account}
